...
function eventHandler() {
  ...
  window.bioEp = {
    ...
    addPopup: function addPopup() {
      ...
      if (document.getElementById('bio_ep')) this.popupEl = document.getElementById('bio_ep');
      else {
    ...
    setOptions: function setOptions(opts) {
      ...
      this.showOnDelay =
        typeof opts.showOnDelay === 'undefined' ? this.showOnDelay : opts.showOnDelay;
  ...
  $('.s-content--main').readmore({
    speed: 75,
    lessLink:
      '<button class="btn btn-toggle-js" type="button">\u0421\u043A\u0440\u044B\u0442\u044C\n\t</button> ',
    moreLink:
      '<button class="btn btn-toggle-js" type="button">\u041F\u043E\u043A\u0430\u0437\u0430\u0442\u044C\n\t</button> ',
  });
...
jQuery(document).ready(function ($) {
  ...
  let tables = document.querySelectorAll(
      '.top-nav .swiper-wrapper>.menu-item-has-children.swiper-slide>ul>li>ul',
    ),
  ...
  $(
    '.top-nav .swiper-wrapper>.menu-item-has-children.swiper-slide>ul>li.menu-item-has-children',
  ).hover(function () {
    let self = $(this);
      ...
      for (const trElement of tr) {
        ...
        trElement.addEventListener('click', function (event) {
          ...
          $.fancybox.open({
            ...
            touch: !1,
            type: 'inline',
            i18n: { en: { CLOSE: 'Закрыть', NEXT: 'Вперед', PREV: 'Назад' } },
          });
        });
      }
    }
